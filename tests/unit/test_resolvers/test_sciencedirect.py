...
class TestScienceDirectUrlToDoi:
    ...
    def test_doi_in_url_path(self):
        ...
        from pyzot.write.resolvers.sciencedirect import url_to_doi
    ...
    def test_pii_extracted_from_url(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "pyzot.write.resolvers.sciencedirect._try_crossref_alternative_id",
    ...
    def test_crossref_alternative_id_called(self, httpserver, monkeypatch):
        ...
        monkeypatch.setattr(
            "pyzot.write.resolvers.sciencedirect._CROSSREF_BASE",
            httpserver.url_for("/works"),
        )

        from pyzot.write.resolvers.sciencedirect import _try_crossref_alternative_id
    ...
    def test_bibliographic_fallback_used_when_alternative_id_empty(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "pyzot.write.resolvers.sciencedirect._try_crossref_bibliographic",
