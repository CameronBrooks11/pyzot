...
from zotcli import __version__
from zotcli.db import ZoteroDatabase
from zotcli.models import Item
from zotcli.queries.items import _build_items, get_item
...
def _fetch_url_text(url: str, username: str | None = None, password: str | None = None) -> str | None:
    ...
    req = urllib.request.Request(url, headers={"User-Agent": f"zotcli/{__version__}"})
