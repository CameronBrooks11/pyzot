"""Session lifecycle management for zotcli write operations.
...
All session records are appended to <zotcli-home>/cache/sessions.jsonl
...
class Session:
    ...
    def save_items(self, items: list[dict], uri: str = "https://zotcli.local/add") -> dict:
    ...
    def _log_session(self) -> None:
        """Append a session record to <zotcli-home>/cache/sessions.jsonl."""
        try:
