...
never at module top-level.  This ensures that ``import zotcli`` never pulls
...
logger = logging.getLogger("zotcli.browser")
...
class BrowserSession:
    ...
    service:
        ...
        subdirectory name under ``<zotcli-home>/cookies/<service>/`` for the
    ...
    def login(self) -> dict:
        ...
        with sync_playwright() as p:
            ...
            print(
                f"\n[zotcli] Opened {display_name} in Chromium.\n"
