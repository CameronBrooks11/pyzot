"""Resolver dispatcher for zotcli write pipeline.

Usage:
    from zotcli.write.resolvers import resolve
...
_RESOLVER_MAP: dict[str, str] = {
    "doi": "zotcli.write.resolvers.crossref",
    "arxiv": "zotcli.write.resolvers.arxiv",
    "pmid": "zotcli.write.resolvers.pubmed",
    "isbn": "zotcli.write.resolvers.openlibrary",
}
