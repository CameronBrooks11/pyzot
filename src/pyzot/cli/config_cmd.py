"""CLI group: zot config — read/write pyzot configuration and per-library auth."""
...
from pyzot.config import get_library_auth, set_library_auth


@click.group("config")
def config_cmd():
    """Manage pyzot settings."""
