...
This module is therefore the second exception to pyzot's "no direct SQLite
writes for item data" rule (the first being :mod:`pyzot.write.collection_assign`).
...
logger = logging.getLogger("pyzot.attach_existing")
