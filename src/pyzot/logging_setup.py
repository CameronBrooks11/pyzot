"""Logging configuration for pyzot.

Sets up a RotatingFileHandler writing to <pyzot-home>/logs/zot.log.
...
logger = logging.getLogger("pyzot")
...
def configure_logging(verbose: bool = False) -> None:
    """Install the rotating file handler on the root 'pyzot' logger.
    ...
    from pyzot.paths import logs_path  # imported lazily to avoid side-effects
